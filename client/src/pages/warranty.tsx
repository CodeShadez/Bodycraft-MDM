  ...
  const getWarrantyStatus = (warrantyExpiry: string | null) => {
    ...
    if (daysUntilExpiry < 0) {
      return {
        ...
        label: "Expired",
        color: "bg-red-400",
        days: Math.abs(Math.floor(daysUntilExpiry)),
      };
    ...
    const matchesStatus =
      ...
      (statusFilter === "expiring-soon" &&
        (warrantyStatus.status === "warning" ||
          warrantyStatus.status === "critical")) ||
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/70 mt-1">
            Centralized warranty tracking and lifecycle management for
            enterprise assets
          </p>
        </div>
      </div>
        ...
        <Card className="glass-card border-0">
          ...
          <CardContent>
            ...
            <p className="text-xs text-white/60">
              Currently under warranty coverage
            </p>
          </CardContent>
        </Card>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-white/10 hover:bg-white/5">
                ...
                <TableHead className="text-white/90 text-right">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-lg bg-muted">
                  <div className="font-medium">
                    {selectedAsset.brand} {selectedAsset.modelName}
                  </div>
