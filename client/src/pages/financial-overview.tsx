      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Manage invoices and track financial data
          </p>
        </div>
        <Button
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="glass-card border-0" data-testid="card-invoice-count">
          ...
          <CardContent>
            <div
              className="text-2xl font-bold text-white/90"
              data-testid="text-invoice-count"
            >
              {totalInvoices}
            </div>
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Select value={categoryFilter} onValueChange={setCategoryFilter}>
              <SelectTrigger
                className="w-full md:w-[200px] backdrop-blur-sm border-border/40"
                      ...
                      <TableCell className="py-3 px-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            ...
                            data-testid={`text-status-${invoice.id}`}
                          >
        ...
        <DialogContent className="bg-white dark:bg-gray-800">
          ...
          <DialogFooter>
            ...
            <Button
              variant="destructive"
              onClick={() =>
                selectedInvoice && deleteMutation.mutate(selectedInvoice.id)
              }
